...
import type { Database, Notificacion } from "@/lib/tipos";
...
/**
 * Avisos de la persona, listos para pintar. Vale con el cliente de
 * servidor (carga de la página) y con el de navegador (la campana se
 * refresca sola). Devuelve null si la tabla aún no existe (019 sin
 * ejecutar). Solo lee los propios (RLS).
 */
