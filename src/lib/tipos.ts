...
/** Cliente × tipo. El catálogo de tipos no tiene tabla propia: es el
 *  conjunto de `nombre` distintos de todas las filas (activas o no);
 *  casilla marcada en Gestión = fila con activo. Ver gestion/acciones. */
